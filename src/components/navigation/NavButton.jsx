    ...
    <ResponsiveComponent>

      {
        ...
        >
          <NavLink
            ...
            className="flex items-center justify-center text-foreground rounded-full custom-bg"
            aria-label={label}
            name={label}
          >
            <span className="w-14 h-14 relative p-4 animate-spin-slow-reverse group-hover:pause hover:text-accent">
                {getIcon(icon)}   
      ...
      >
        <NavLink
          ...
          name={label}
        >
          <span className="xs:w-14 xs:h-14 w-10 h-10 relative p-2.5 xs:p-4 hover:text-accent">
              {getIcon(icon)}   
              <span className="peer bg-transparent absolute top-0 left-0 w-full h-full"/>
